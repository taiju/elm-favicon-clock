...
var _taiju$elm_favicon_clock$FaviconClock$init = function (flag) {
	return {ctor: '_Tuple2', _0: flag, _1: _elm_lang$core$Platform_Cmd$none};
};
var _taiju$elm_favicon_clock$FaviconClock$fromTimeToMinute = function (_p0) {
	return _elm_lang$core$Date$minute(
		_elm_lang$core$Date$fromTime(_p0));
};
var _taiju$elm_favicon_clock$FaviconClock$fromTimeToHour = function (_p1) {
	return _elm_lang$core$Date$hour(
		_elm_lang$core$Date$fromTime(_p1));
};
var _taiju$elm_favicon_clock$FaviconClock$fromTimeTo = function (cltype) {
	var _p2 = cltype;
	switch (_p2) {
		case 'min':
			return _taiju$elm_favicon_clock$FaviconClock$fromTimeToMinute;
		case 'hour':
			return _taiju$elm_favicon_clock$FaviconClock$fromTimeToHour;
		default:
			return _taiju$elm_favicon_clock$FaviconClock$fromTimeToMinute;
	}
};
var _taiju$elm_favicon_clock$FaviconClock$fontSize = 14;
var _taiju$elm_favicon_clock$FaviconClock$textStyle = {
	typeface: {
		ctor: '::',
		_0: 'monospace',
		_1: {ctor: '[]'}
	},
	height: _elm_lang$core$Maybe$Just(_taiju$elm_favicon_clock$FaviconClock$fontSize),
	color: _elm_lang$core$Color$black,
	bold: false,
	italic: false,
	line: _elm_lang$core$Maybe$Nothing
};
var _taiju$elm_favicon_clock$FaviconClock$canvasHeight = 16;
var _taiju$elm_favicon_clock$FaviconClock$canvasWidth = 16;
var _taiju$elm_favicon_clock$FaviconClock$view = function (model) {
	return _evancz$elm_graphics$Element$toHtml(
		A3(
			_evancz$elm_graphics$Collage$collage,
			_taiju$elm_favicon_clock$FaviconClock$canvasWidth,
			_taiju$elm_favicon_clock$FaviconClock$canvasHeight,
			{
				ctor: '::',
...
var _taiju$elm_favicon_clock$FaviconClock$updateFavicon = _elm_lang$core$Native_Platform.outgoingPort(
	'updateFavicon',
	function (v) {
		return v;
	});
var _taiju$elm_favicon_clock$FaviconClock$update = F2(
	function (msg, model) {
		var _p3 = msg;
		var _p4 = _p3._0;
		return A2(
			...
			{
				ctor: '::',
				_0: _taiju$elm_favicon_clock$FaviconClock$updateFavicon(
					A2(_taiju$elm_favicon_clock$FaviconClock$fromTimeTo, model.cltype, _p4)),
				_1: {ctor: '[]'}
			});
	});
var _taiju$elm_favicon_clock$FaviconClock$Model = F2(
	function (a, b) {
		return {cltype: a, time: b};
	});
var _taiju$elm_favicon_clock$FaviconClock$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _taiju$elm_favicon_clock$FaviconClock$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _taiju$elm_favicon_clock$FaviconClock$Tick);
};
var _taiju$elm_favicon_clock$FaviconClock$main = _elm_lang$html$Html$programWithFlags(
	{init: _taiju$elm_favicon_clock$FaviconClock$init, update: _taiju$elm_favicon_clock$FaviconClock$update, subscriptions: _taiju$elm_favicon_clock$FaviconClock$subscriptions, view: _taiju$elm_favicon_clock$FaviconClock$view})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (cltype) {
			return A2(
				...
				function (time) {
					return _elm_lang$core$Json_Decode$succeed(
						{cltype: cltype, time: time});
				},
				A2(_elm_lang$core$Json_Decode$field, 'time', _elm_lang$core$Json_Decode$float));
		},
		A2(_elm_lang$core$Json_Decode$field, 'cltype', _elm_lang$core$Json_Decode$string)));

var Elm = {};
Elm['FaviconClock'] = Elm['FaviconClock'] || {};
if (typeof _taiju$elm_favicon_clock$FaviconClock$main !== 'undefined') {
    _taiju$elm_favicon_clock$FaviconClock$main(Elm['FaviconClock'], 'FaviconClock', undefined);
}
